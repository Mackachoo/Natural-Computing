...
def main(crossoverRate=0.7, mutationRate=0.01, iterations=50, numInitials=50, survivalRate=0.5, elitism=True):
    log = "LOG FILE -------------------\n\n"
    ...
    for _ in tqdm(range(iterations)):
        scored = scores(networkSet, 'square')
