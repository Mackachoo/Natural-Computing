...
def scores(nws, maxIt, type='lin'):
    ...
    for nw in nws:
        with warnings.catch_warnings():
            ...
            valuePred = mlp.predict(posTest)
            print(valueTest.all() == valuePred.all(),end=' - loss: ')
            print(loss(valueTest, valuePred))
...
def main(crossoverRate=0.7, mutationRate=0.01, iterations=50, numInitials=100, survivalRate=0.5, elitism=True, maxMLPit=1, MLPtype='square',  oldSelect=False):
    #log = "LOG FILE -------------------\n\n"
